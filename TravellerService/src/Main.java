...
public class Main {
    ...
    final static String outputFilePath = "/OOPII_21713/TravellerService/src/Service/hmaptraveller.txt";
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		ArrayList<City> cityobjects = new ArrayList<City>();
		// create arralist of traveller objects //
		ArrayList<Traveller> travobjects = new ArrayList<Traveller>(); */

        // trmap and citymap hold a string(city's name) and an object //
        ...
        try (Scanner s = new Scanner(System.in)) {
            ...
            // checking passengers attribute and reading fields //
            ...
            while (true) {
                ...
                try {
                    if(getPassengersAttribute().equals("traveller")) {
                        ...
                        // add City objects in cityobjects list //
